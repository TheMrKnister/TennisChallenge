 ...
 * contains layout: '' & 'german-qwertz-2'
 *
 * To use:
...
$.keyboard.layouts['e-mail-input'] = {
  'default': [
		"@ 1 2 3 4 5 6 7 8 9 0 ' \u0302 {bksp}",
		"{tab} q w e r t z u i o p \u00fc \u0308 .com",
		"a s d f g h j k l \u00f6 \u00e4 $ .ch",
		"{shift} _ y x c v b n m , . - {shift}",
