...
TennisChallenge.InfoBoard.Model = (function ($) {
  var utils = TennisChallenge.Utils,
      ...
      setRfidCall = function (callback) {
        ...
        cancel = function () {
          if (state === states.LOGIN || state === states.ALREADY_BOOKED ||
  ...
  var model = TennisChallenge.InfoBoard.Model,
      ...
      applyLiInfos = function (courtId, bookings) {
        $('#' + courtId + ' li.booked').each(function (index, val) {
          ...
          switch (bookings[index].TypeOfGame) {
            case 0:
              bookingTypeString = "";
              break;
            case 1:
              bookingTypeString = "GESPERT";
              break;
            case 2:
              bookingTypeString = "Tennisschule";
              break;
            case 3:
              bookingTypeString = "Interclub";
              break;
            case 4:
              bookingTypeString = "Plauschturnier";
              break;
          ...
          if (bookings[index].TypeOfGame != 0) {
            ...
            if (bookings[index].CourtComment != null) {
              $(selectorBase + ' .row-' + index + ' .player0-infos').text(bookings[index].CourtComment);
            } else {
          ...
          if (bookingIndex < bookingCount) {
            ...
            if (((liIndex === 0) && (tDiff < 5)) || (tDiff < DEFAULT_BLOCK_TIME)) {
              ...
              $('#' + courtId + ' .booking-bar').click(function () {
                ...
                setTimeout(function () { $('#' + courtId + ' .show-booking-infos').hide(); $('#close-click-helper').remove(); }, 5000);
